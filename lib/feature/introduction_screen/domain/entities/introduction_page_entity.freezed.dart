...
part of 'introduction_page_entity.dart';
...
/// @nodoc
mixin _$IntroductionPageEntity {
...
@override
String toString() {
  return 'IntroductionPageEntity(title: $title, highlight: $highlight, description: $description, imagePath: $imagePath, badge: $badge, showLogo: $showLogo, stepIndicator: $stepIndicator, stepIndicatorTop: $stepIndicatorTop)';
}
...
/// @nodoc
abstract mixin class $IntroductionPageEntityCopyWith<$Res>  {
  factory $IntroductionPageEntityCopyWith(IntroductionPageEntity value, $Res Function(IntroductionPageEntity) _then) = _$IntroductionPageEntityCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$IntroductionPageEntityCopyWithImpl<$Res>
    implements $IntroductionPageEntityCopyWith<$Res> {
  _$IntroductionPageEntityCopyWithImpl(this._self, this._then);

  final IntroductionPageEntity _self;
  final $Res Function(IntroductionPageEntity) _then;
...
/// Adds pattern-matching-related methods to [IntroductionPageEntity].
extension IntroductionPageEntityPatterns on IntroductionPageEntity {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _IntroductionPageEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _IntroductionPageEntity() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _IntroductionPageEntity value)  $default,){
final _that = this;
switch (_that) {
case _IntroductionPageEntity():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _IntroductionPageEntity value)?  $default,){
final _that = this;
switch (_that) {
case _IntroductionPageEntity() when $default != null:
return $default(_that);case _:
...
class _IntroductionPageEntity implements IntroductionPageEntity {
  const _IntroductionPageEntity({required this.title, required this.highlight, required this.description, required this.imagePath, required this.badge, this.showLogo = false, this.stepIndicator, this.stepIndicatorTop});
...
@pragma('vm:prefer-inline')
_$IntroductionPageEntityCopyWith<_IntroductionPageEntity> get copyWith => __$IntroductionPageEntityCopyWithImpl<_IntroductionPageEntity>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IntroductionPageEntity&&(identical(other.title, title) || other.title == title)&&(identical(other.highlight, highlight) || other.highlight == highlight)&&(identical(other.description, description) || other.description == description)&&(identical(other.imagePath, imagePath) || other.imagePath == imagePath)&&(identical(other.badge, badge) || other.badge == badge)&&(identical(other.showLogo, showLogo) || other.showLogo == showLogo)&&(identical(other.stepIndicator, stepIndicator) || other.stepIndicator == stepIndicator)&&(identical(other.stepIndicatorTop, stepIndicatorTop) || other.stepIndicatorTop == stepIndicatorTop));
}
...
/// @nodoc
abstract mixin class _$IntroductionPageEntityCopyWith<$Res> implements $IntroductionPageEntityCopyWith<$Res> {
  factory _$IntroductionPageEntityCopyWith(_IntroductionPageEntity value, $Res Function(_IntroductionPageEntity) _then) = __$IntroductionPageEntityCopyWithImpl;
@override @useResult
$Res call({
 String title, String highlight, String description, String imagePath, String badge, bool showLogo, String? stepIndicator, String? stepIndicatorTop
});
...
/// @nodoc
class __$IntroductionPageEntityCopyWithImpl<$Res>
    implements _$IntroductionPageEntityCopyWith<$Res> {
  __$IntroductionPageEntityCopyWithImpl(this._self, this._then);

  final _IntroductionPageEntity _self;
  final $Res Function(_IntroductionPageEntity) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? highlight = null,Object? description = null,Object? imagePath = null,Object? badge = null,Object? showLogo = null,Object? stepIndicator = freezed,Object? stepIndicatorTop = freezed,}) {
  return _then(_IntroductionPageEntity(
title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,highlight: null == highlight ? _self.highlight : highlight // ignore: cast_nullable_to_non_nullable
as String,description: null == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
as String,imagePath: null == imagePath ? _self.imagePath : imagePath // ignore: cast_nullable_to_non_nullable
