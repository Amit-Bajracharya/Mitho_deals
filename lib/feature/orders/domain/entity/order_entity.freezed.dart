...
// Optionally joined deal data so UI can show food name & image
 String get vendorName;// Name of the restaurant/vendor
 DealEntity? get deal;
...
@override
int get hashCode => Object.hash(runtimeType,id,userId,dealId,vendorId,quantity,totalAmount,status,pickupCode,orderPlacedTime,vendorName,deal);

@override
String toString() {
  return 'OrderEntity(id: $id, userId: $userId, dealId: $dealId, vendorId: $vendorId, quantity: $quantity, totalAmount: $totalAmount, status: $status, pickupCode: $pickupCode, orderPlacedTime: $orderPlacedTime, vendorName: $vendorName, deal: $deal)';
}
...
@useResult
$Res call({
 String id, String userId, String dealId, String vendorId, int quantity, double totalAmount, String status, String pickupCode, DateTime orderPlacedTime, String vendorName, DealEntity? deal
});
...
/// Create a copy of OrderEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? dealId = null,Object? vendorId = null,Object? quantity = null,Object? totalAmount = null,Object? status = null,Object? pickupCode = null,Object? orderPlacedTime = null,Object? vendorName = null,Object? deal = freezed,}) {
...
as DateTime,vendorName: null == vendorName ? _self.vendorName : vendorName // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String dealId,  String vendorId,  int quantity,  double totalAmount,  String status,  String pickupCode,  DateTime orderPlacedTime,  String vendorName,  DealEntity? deal)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderEntity() when $default != null:
return $default(_that.id,_that.userId,_that.dealId,_that.vendorId,_that.quantity,_that.totalAmount,_that.status,_that.pickupCode,_that.orderPlacedTime,_that.vendorName,_that.deal);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String dealId,  String vendorId,  int quantity,  double totalAmount,  String status,  String pickupCode,  DateTime orderPlacedTime,  String vendorName,  DealEntity? deal)  $default,) {final _that = this;
switch (_that) {
case _OrderEntity():
return $default(_that.id,_that.userId,_that.dealId,_that.vendorId,_that.quantity,_that.totalAmount,_that.status,_that.pickupCode,_that.orderPlacedTime,_that.vendorName,_that.deal);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String dealId,  String vendorId,  int quantity,  double totalAmount,  String status,  String pickupCode,  DateTime orderPlacedTime,  String vendorName,  DealEntity? deal)?  $default,) {final _that = this;
switch (_that) {
case _OrderEntity() when $default != null:
return $default(_that.id,_that.userId,_that.dealId,_that.vendorId,_that.quantity,_that.totalAmount,_that.status,_that.pickupCode,_that.orderPlacedTime,_that.vendorName,_that.deal);case _:
  return null;
...
class _OrderEntity implements OrderEntity {
  const _OrderEntity({required this.id, required this.userId, required this.dealId, required this.vendorId, required this.quantity, required this.totalAmount, required this.status, required this.pickupCode, required this.orderPlacedTime, required this.vendorName, this.deal});
...
/// Create a copy of OrderEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? dealId = null,Object? vendorId = null,Object? quantity = null,Object? totalAmount = null,Object? status = null,Object? pickupCode = null,Object? orderPlacedTime = null,Object? vendorName = null,Object? deal = freezed,}) {
