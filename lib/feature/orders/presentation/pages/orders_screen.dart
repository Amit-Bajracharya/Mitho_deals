          ...
          if (isActive) ...[
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.qr_code_2_rounded, color: const Color(0xFFF97316), size: 24.sp),
                  SizedBox(width: 8.w),
                  Text(
                    'Pickup Code: ',
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'No orders yet',
            style: GoogleFonts.poppins(fontSize: 18.sp, fontWeight: FontWeight.w600, color: Colors.grey),
          ),
          SizedBox(height: 8.h),
          Text(
            'Explore deals and start rescuing food!',
