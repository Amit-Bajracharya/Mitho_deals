...
@override
String toString() {
  return 'OrderModel(id: $id, userId: $userId, dealId: $dealId, vendorId: $vendorId, quantity: $quantity, totalAmount: $totalAmount, status: $status, pickupCode: $pickupCode, orderPlacedTime: $orderPlacedTime, deal: $deal)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'deal_id') String dealId,@JsonKey(name: 'vendor_id') String vendorId, int quantity,@JsonKey(name: 'total_amount') double totalAmount, String status,@JsonKey(name: 'pickup_code') String pickupCode,@JsonKey(name: 'order_placed_time') DateTime orderPlacedTime,@JsonKey(name: 'deals') DealModel? deal
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'deal_id')  String dealId, @JsonKey(name: 'vendor_id')  String vendorId,  int quantity, @JsonKey(name: 'total_amount')  double totalAmount,  String status, @JsonKey(name: 'pickup_code')  String pickupCode, @JsonKey(name: 'order_placed_time')  DateTime orderPlacedTime, @JsonKey(name: 'deals')  DealModel? deal)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'deal_id')  String dealId, @JsonKey(name: 'vendor_id')  String vendorId,  int quantity, @JsonKey(name: 'total_amount')  double totalAmount,  String status, @JsonKey(name: 'pickup_code')  String pickupCode, @JsonKey(name: 'order_placed_time')  DateTime orderPlacedTime, @JsonKey(name: 'deals')  DealModel? deal)  $default,) {final _that = this;
switch (_that) {
case _OrderModel():
return $default(_that.id,_that.userId,_that.dealId,_that.vendorId,_that.quantity,_that.totalAmount,_that.status,_that.pickupCode,_that.orderPlacedTime,_that.deal);case _:
  throw StateError('Unexpected subclass');
