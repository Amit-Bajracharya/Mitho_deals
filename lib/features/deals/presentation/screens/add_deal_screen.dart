...
class _AddDealScreenState extends State<AddDealScreen> {
  ...
  void _submit() {
    ...
    final deal = DealEntity(
      ...
      vendorId: '', // Will be set by DataSource from auth
      ...
      isAvailable: true,
      vendorName: '', // Not needed for creation
      vendorAddress: '', // Not needed for creation
      latitude: 0.0, // Not needed for creation
      longitude: 0.0, // Not needed for creation
    );
