...
class Initial implements OrdersState {
  const Initial();
...
class Loading implements OrdersState {
  const Loading();
...
class Loaded implements OrdersState {
...
/// @nodoc
abstract mixin class $LoadedCopyWith<$Res> implements $OrdersStateCopyWith<$Res> {
...
class Error implements OrdersState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $OrdersStateCopyWith<$Res> {
